...
class FinanceDataStorage:
    ...
    def __init__(
        ...
        """ finance data을 저장하는 object storage에 대한 저장소
    ...
    def download(self, ticker: str, data_date: date) -> pd.DataFrame:
        ...
        csv_string = self._read_data(self.to_key(ticker, data_date))
    ...
    def _write_data(self, key: str, body: str):
        try:
